...
<html>
  ...
  <div class="container-fluid">
    ...
    <h1>FEEDBACK <small>TEACHER</small></h1> <form class="form-horizontal" method="post" action="connect.php">
            <div class='form-group'>
            <label class="control-label col-sm-2" for="Rollno">Prof Id:</label>
      <div class="col-sm-4">
...
<option>B.Sc</option>
    ...
    <div class="col-sm-offset-2 col-sm-10">
            <input class="btn btn-default" type="submit" name="submitt">
                </div></div>
